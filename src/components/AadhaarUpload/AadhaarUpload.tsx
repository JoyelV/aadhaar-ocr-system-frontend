...
const AadhaarUpload: React.FC = () => {
  ...
  const handleRemove = (
    ...
    toast.info(`${preview ? 'Image removed' : 'No image to remove'}`);
  };
        ...
        <div className={styles.uploadSectionWrapper}>
          <div className={styles.uploadBox}>
            <UploadSection
              ...
              onRemove={() => handleRemove(setFrontFile, setFrontPreview, frontPreview)} // Pass remove handler
            />
            <UploadSection
              label="Aadhaar Back"
              preview={backPreview}
              ...
              onRemove={() => handleRemove(setBackFile, setBackPreview, backPreview)} // Pass remove handler
            />
